...
async def remove_channel_member(user_id: str, ctx: ChannelCtx, db: DbSession) -> OkResponse:
...
async def update_channel_member_role(
    user_id: str, payload: UpdateMemberRoleRequest, ctx: ChannelCtx, db: DbSession
) -> ChannelMemberOut:
